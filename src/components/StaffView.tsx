    ...
    <div className="space-y-5 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {users.map(u => (
          <div
            key={u.id}
            className="p-5 rounded-2xl border flex items-start gap-4 transition-all bg-emerald-950/40 border-emerald-900"
          >
            <img
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
          <div className="w-full max-w-md rounded-2xl shadow-2xl border p-5 space-y-4 bg-emerald-950 border-emerald-800 text-emerald-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 rounded-xl border bg-emerald-900/40 border-emerald-800 text-white placeholder-emerald-500"
                />
              </div>

              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block font-bold mb-1 text-emerald-200">E-mail</label>
                  <input
                    type="email"
                    required
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-2 rounded-xl border bg-emerald-900/40 border-emerald-800 text-white"
                  >
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <label className="block font-bold mb-1 text-emerald-200">Telefone</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block font-bold mb-1 text-emerald-200">Categoria CNH</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block font-bold mb-1 text-emerald-200">Validade CNH</label>
                  <input
                    type="date"
                    value={cnhExpiration}
